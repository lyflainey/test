...
public class LocationCodeService{
    public static void getLocationcode1(){
        ...
        int count=0;
        try {
        	String filename=LocationCodeService.class.getResource("/").getPath()+"locationcode/locationcode1.txt";
            ...
            if(!file.exists()){
            	...
            	String filename_out=LocationCodeService.class.getResource("/").getPath()+"locationcode/locationcode1.output";
    ...
    public static void getLocationcode2(){
        ...
        int count=0;
        try {
        	String filename=LocationCodeService.class.getResource("/").getPath()+"locationcode/locationcode2.txt";
            File file=new File(filename);
            if(!file.exists()){
            	System.out.println("file exists false");
            }else{
            	...
            	String filename_out=LocationCodeService.class.getResource("/").getPath()+"locationcode/locationcode2.output";
                file=new File(filename_out);
                if(file.exists()){
                	file.delete();
                }
